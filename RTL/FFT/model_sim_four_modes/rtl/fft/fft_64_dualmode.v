// FFT64 radix-2 DIF parametrizavel para os dois experimentos do PBL-FFT (9.15 ou 11.16)
...
module fft_64_dualmode #(
    ...
    function signed [MULT_WIDTH:0] round_product_full;
    ...
    function signed [FFT_WIDTH-1:0] round_half_sum;
        input signed [DIFF_WIDTH-1:0] value;
        ...
        begin
            ...
            if (value_ext < 0) begin
                magnitude = -value_ext;
                round_half_sum = -$signed((magnitude + 1'b1) >> 1);
            end else begin
                round_half_sum = $signed((value_ext + 1'b1) >> 1);
            end
        end
    endfunction
