...
module preprocess_lms_fft_four_modes #(
    ...
    parameter FIR_STAGE2_FILE =
        "model_sim_four_modes/coefficients/fir/stage2_decim4_q117.hex",
    parameter FIR_STAGE3_FILE =
        "model_sim_four_modes/coefficients/fir/stage3_decim2_q117.hex",
    parameter HANN_FILE =
        "model_sim_four_modes/coefficients/windowing/hann_64_q117.hex"
)(
    input  wire                           clk,
    input  wire                           reset,
