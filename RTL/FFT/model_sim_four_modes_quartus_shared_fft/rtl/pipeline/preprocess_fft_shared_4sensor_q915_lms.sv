...
`endif
    ...
    output wire [3:0]                    lms_output_events,
    output wire [3:0]                    lms_error_saturation_events,
    output wire [3:0]                    lms_prediction_saturation_events,
    output wire [3:0]                    lms_coefficient_saturation_events,
    ...
    preprocess_window_channel_lms #(
        ...
        .lms_output_event                 (lms_output_events[0]),
        .lms_error_saturation_event       (lms_error_saturation_events[0]),
        .lms_prediction_saturation_event  (lms_prediction_saturation_events[0]),
        .lms_coefficient_saturation_event (lms_coefficient_saturation_events[0]),
    ...
    preprocess_window_channel_lms #(
        ...
        .lms_output_event                 (lms_output_events[1]),
        .lms_error_saturation_event       (lms_error_saturation_events[1]),
        .lms_prediction_saturation_event  (lms_prediction_saturation_events[1]),
        .lms_coefficient_saturation_event (lms_coefficient_saturation_events[1]),
    ...
    preprocess_window_channel_lms #(
        ...
        .lms_output_event                 (lms_output_events[2]),
        .lms_error_saturation_event       (lms_error_saturation_events[2]),
        .lms_prediction_saturation_event  (lms_prediction_saturation_events[2]),
        .lms_coefficient_saturation_event (lms_coefficient_saturation_events[2]),
    ...
    preprocess_window_channel_lms #(
        ...
        .lms_output_event                 (lms_output_events[3]),
        .lms_error_saturation_event       (lms_error_saturation_events[3]),
        .lms_prediction_saturation_event  (lms_prediction_saturation_events[3]),
        .lms_coefficient_saturation_event (lms_coefficient_saturation_events[3]),
    ...
    always @(posedge clk) begin
        if (!reset && sample_valid && sample_ready) begin
            if (channel_input_ready !== 4'b1111)
                $fatal(1, "[shared_4sensor_lms] Aceitacao nao atomica.");
        end
    end
