...
class maxpool_2x2_driver extends uvm_driver #(maxpool_2x2_seq_item);
    ...
    //  maxpool_2x2_uvm_top.sv; it belongs here because the driver is
    ...
    task reset_phase(uvm_phase phase);
        phase.raise_objection(this, "maxpool_2x2: applying reset");
        ...
        phase.drop_objection(this, "maxpool_2x2: reset released");
    endtask
