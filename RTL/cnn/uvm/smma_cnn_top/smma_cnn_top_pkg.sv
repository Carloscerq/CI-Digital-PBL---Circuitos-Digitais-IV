// ---------------------------------------------------------------------
//  smma_cnn_top_pkg  --  all UVM classes for the smma_cnn_top
//  top-level-integration testbench. smma_cnn_top_if.sv is intentionally
...
//  matching tb_smma_cnn_top.sv's/smma_cnn_top.sv's default instance
...
package smma_cnn_top_pkg;
    ...
    `include "smma_cnn_top_seq_item.sv"
    `include "smma_cnn_top_sequences.sv"
    `include "smma_cnn_top_driver.sv"
    `include "smma_cnn_top_monitor.sv"
    `include "smma_cnn_top_agent.sv"
    `include "smma_cnn_top_scoreboard.sv"
    `include "smma_cnn_top_env.sv"
    `include "smma_cnn_top_test.sv"
